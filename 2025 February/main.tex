	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item Tests: validación numerica \done, funcionalidades \todo
				\item Infraestructura: metadatos \done, binarios \doing
				\item Publicación: código \done, documentación \done, paquete \todo
			\end{itemize}
		\end{itemize}
	\end{frame}
